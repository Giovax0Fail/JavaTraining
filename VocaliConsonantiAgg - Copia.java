    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < nomeininputLowercase.length(); i++) {
            ...
            if (vocali.indexOf(carattereStringaInput) >= 0) {
                if (!mapVocali.containsKey(carattereStringaInput)) {
                    mapVocali.put(carattereStringaInput, 1);
            ...
            // Se il carattere è una consonante
                ...
                if (!mapConsonanti.containsKey(carattereStringaInput)) {
                    mapConsonanti.put(carattereStringaInput, 1);
